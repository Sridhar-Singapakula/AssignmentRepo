...
const ClientDetails = () => {
  ...
  const columns = ['ClientName', 'MobileNumber', 'EmailId', 'Address', 'totalCost', 'CurrentBalance','RecordRegisteredDate',"EditDetails"];
  const pageLimit = 10;
    ...
    return clients
      .map((client) => {
        ...
        return {
          ...
          RecordRegisteredDate: client.dateOfCreation,
          EditDetails:<button className="button-17" onClick={() => openUpload(client._id)} >Edit Details</button>
        };
      });
  };
